...
class WFP_Integration {
	...
	public static function get_builtin_categories() {
		return array(
			'spam_protection' => __( 'Spam protection', 'wing-forms' ),
			'email_marketing' => __( 'Email marketing', 'wing-forms' ),
			'payments' => __( 'Payments', 'wing-forms' ),
		);
	}
	 ...
	 *
	 * @return WFP_Integration The instance.
	 */
	 ...
	 */
	public function add_service( $name, WFP_Service $service ) {
	 ...
	 * @return WFP_Service|bool The service object if it exists,
	 *                            false otherwise.
	 */
 ...
 * your aim is advised.
 */
class WFP_Service_OAuth2 extends WFP_Service {
	...
	protected function menu_page_url( $args = '' ) {
		return menu_page_url( 'wfp-integration', false );
	}
